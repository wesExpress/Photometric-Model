...
{
    name = "distance";
    std::uniform_real_distribution<float> distance_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
...
{
    name = "inclination";
    std::uniform_real_distribution<float> inc_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
    return inc_dist(rng);
}
...
{
    name = "surf_disk";
    std::uniform_real_distribution<float> surf_disk_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
...
{
    name = "disk_scale";
    std::uniform_real_distribution<float> disk_scale_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
...
{
    name = "disk_pa";
    std::uniform_real_distribution<float> pa_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
    return pa_dist(rng);
}
...
{
    name = "surf_bar";
    std::uniform_real_distribution<float> surf_bar_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
...
{
    name = "bar_ecc";
    std::uniform_real_distribution<float> bar_ecc_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
...
{
    name = "bar_len";
    std::uniform_real_distribution<float> bar_len_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
...
{
    name = "bar_shape";
    std::uniform_real_distribution<float> bar_shape_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
...
{
    name = "bar_scale";
    std::uniform_real_distribution<float> bar_scale_dist{io.GetValue(name,minCol),io.GetValue(name,maxCol)};
